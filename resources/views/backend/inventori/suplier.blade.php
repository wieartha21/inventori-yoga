    ...
    <div class="col-lg-12">
        <div class="card m-b-30">
            ...
            <div class="card-header bg-white">
                ...
                <h6 class="card-subtitle">Halaman Pengelolaan Data Suplier</h6>
            </div>

            <div class="card-body">
                <a href="{{ url('/operator/fsuplier') }}"><button class="btn btn-info btn-xs"><i class="fa fa-plus"></i> Tambah Suplier </button><br/><br/></a>
                            ...
                            @foreach ($suplier as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        &nbsp;
                                        <a href="{{ url('/operator/hapusSuplier') }}?id={{ encrypt($item->id) }}" onclick="return confirm('Yakin akan hapus data : {{ $item->title }} ?')" class="text-danger"><i class=" fa fa-trash"></i> Hapus </a>
                                        &nbsp;
