    ...
    <div class="col-lg-12">
        <div class="card m-b-30">
            ...
            <div class="card-header bg-white">
                ...
                <h6 class="card-subtitle">Halaman Pengelolaan Data Merk</h6>
            </div>

            <div class="card-body">
                <a href="{{ url('/operator/fmerk') }}"><button class="btn btn-info btn-xs"><i class="fa fa-plus"></i> Tambah Merk </button><br/><br/></a>
                            ...
                            @foreach ($merk as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        &nbsp;
                                        <a href="{{ url('/operator/hapusMerk') }}?id={{ encrypt($item->id) }}" onclick="return confirm('Yakin akan hapus data : {{ $item->name }} ?')" class="text-danger"><i class=" fa fa-trash"></i> Hapus </a>
                                        &nbsp;
