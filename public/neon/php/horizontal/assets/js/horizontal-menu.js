	...
	$.fn.xpNav = function () {
		return this.each( function() {
			var getNav		= $(this),
				...
				navigation 	= getNav.find('.xp-horizontal-menu'),
			...
			getNav.find('.xp-horizontal-menu').each(function(){
				var $menu = $(this);
			...
			function xpStickyNav() {
				...
				if( winWidth > 1599 && scrollTop > xlTop ){
					...
					getNav.removeClass('xp-sticky-navbar');
				}
			}
			if( getNav.hasClass('xp-fixed-navbar') ){
