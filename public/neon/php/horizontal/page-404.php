                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="xp-error-box text-center">
                                    ...
                                    <h4 class="xp-error-subtitle text-black m-b-30"><i class="mdi mdi-emoticon-sad text-danger font-32"></i>pps! Page not Found</h4>
                                    <p class="text-muted m-b-30">The page you're looking for doesn't exist.</p>
                                    <a href="index.php" class="btn btn-primary btn-rounded mb-3"><i class="icon-home"></i> Take Me Home</a>
                                </div>
                            </div>
                        </div>
